    ...
    <div class="section">
      <div class="container">
        <div class="row">
               ...
               <div class="col-md-3">
                  <a href="connections.php" class="btn btn-block btn-lg btn-primary" id="viewConnections">View connections</a>
               </div>
               <div class="col-md-3">
                  <a href="ownProjects.php" class="btn btn-block btn-lg btn-primary" id="viewProjects">View my projects</a>
               </div>
               <div class="col-md-3">
