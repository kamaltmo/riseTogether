...
include('signup.php'); // Includes Login Script
   ...
   if(isset($_SESSION['login_user']))
    ...
    if ($conn->connect_error) {
      ...
      $sql = "SELECT * FROM profile WHERE onsite=1";
...
<html><head>
    ...
    <link rel="stylesheet" href="bootstrap.min.css">
    <link rel="stylesheet" href="bootstrap.min.css">
  <link rel="stylesheet" href="bootstrap.min.css"><link rel="stylesheet" href="bootstrap.min.css"><link rel="stylesheet" href="bootstrap.min.css"><link rel="stylesheet" href="bootstrap.min.css"><link rel="stylesheet" href="bootstrap.min.css"><link rel="stylesheet" href="bootstrap.min.css"></head><body>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <h1 class="text-primary"><b>Welcome to RT</b></h1>
              <p class="lead"><b>Connect and Collaborate with other Startups to get where you need to be.
                <br>Get. Give. Rise. Together.</b></p>
                <h1 class="text-muted" style="color:white;">
                <span class="label label-success"><?php echo $active ?></span>
                <b>On Site Users</b>
              </h1>
              <br>
              <br>
              <a class="btn btn-lg btn-primary" data-toggle="modal" data-target="#SignUp">Sign Up</a>
            </div>
          </div>
        </div>
      </div>
...
<div class="fade modal text-center" id="SignUp">
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-footer"><button name="submitSignup" type="submit" class="btn btn-primary">Sign Up</button></div>
         </form>
      </div>
   </div>
</div>
