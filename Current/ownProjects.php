...
<html><head>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1><?php if ($requestProj->num_rows < 1) { echo "Project requests - Sorry, you have no project requests.";}
  ...
  <?php
    ...
    <footer class="section section-primary">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
          <h1><?php if ($inprocessProject->num_rows < 1) { echo "Projects in Progress - Sorry, you have no projects in progress.";}
                                             else { echo "projects in progress";} ?><br></h1>
      ...
      <?php
        while ($row = $inprocessProject -> fetch_assoc() ) {
          ...
          echo  '<div class="panel panel-primary">
            ...
            <h1><?php if ($finishedProject->num_rows < 1) { echo "Finished Projects - Sorry, you have no finished Projects.";}
                                             else { echo "Finished Projects";} ?><br></h1>
